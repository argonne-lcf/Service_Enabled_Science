"""
Script to tail the content of a file on a filesystem.
...
def submit_tail_file(file_path: str) -> str:

    # Isolate targetted filesystem
    resource_id = get_filesystem_id_from_path(file_path)

    # Submit tail command
    print(f"Submitting filesystem tail command to {resource_id} ...")
...
if __name__ == "__main__":
    ...
    task_id = submit_tail_file(args.file_path)
