"""
Script to head the content of a file on a filesystem.
...
def submit_head_file(file_path: str) -> str:

    # Isolate targetted filesystem
    resource_id = get_filesystem_id_from_path(file_path)

    # Submit head command
    print(f"Submitting filesystem head command to {resource_id} ...")
...
if __name__ == "__main__":
    ...
    task_id = submit_head_file(args.file_path)
